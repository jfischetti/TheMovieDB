...
class CoreDataStack: DataManager {
    ...
    func addContent(content: ContentProtocol) {
        let entity = NSEntityDescription.entity(forEntityName: "Content", in: self.managedObjectContext)!
        ...
        coreDataContent.type = content as? Movie != nil ? "movie" : "tv"
    ...
    func getContent(by id: Int) -> ContentProtocol? {
        ...
        let content = coreDataContents.first!
